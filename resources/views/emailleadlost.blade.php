...
<body style="background-color: #f9fafb; padding: 20px; font-family: Arial, sans-serif;">
    ...
    <div class="container max-w-screen-md mx-auto bg-gray-100 rounded-lg shadow-md">
            ...
            <div class="subject-section bg-blue-600 py-6 text-center text-white">
                <h2 class="text-3xl font-bold tracking-wide">Désolé {{ $lead->nom }} !</h2>
            </div>

            <!-- Text Section -->
            <div class="text-section py-6 bg-white">
                <p class="text-lg leading-loose text-gray-700">Nous regrettons de vous informer que vous avez  suggeré comme vous avez perdu dans l'opportunité d'achat pour l'entreprise SARL SPC GB, équipe Toudja.</p>
            </div>
