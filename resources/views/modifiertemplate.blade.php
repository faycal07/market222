		...
		<div class="main">
			...
			<div class="report-container mt-0 pt-8 px-3">
				<div class="form-container max-w-lg mx-auto ">
					<h2 class="max-w-lg text-3xl font-semibold leading-normal text-gray-700 dark:text-slate-500 text-center py-3">Modifier Template</h2>
...
>>>>>>> e87245b674945d1c900369974ce08a2c3b35d22e
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{route('emails.index')}}" onclick="scrollToStart()" class="text-white bg-gradient-to-br from-red-400 to-purple-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Annuler</a>
                                </div>
                            </form>
